...
topic_id = 'USGS-JPN_ETL_data'
subscription_id = 'USGS-JPN_data-sub'
timeout = 20  #Time the subscriber client awaits for a message
topic_bq_id = "To_USGS-JPN_Big_Query"
schema_id = "USGS_schema"
message_encoding = "JSON"
#Dataset_id = "AIRFLOW"
Dataset_id = "AIRFLOW"
Table_CHI_id = "USGS_JPN"
...
# File log config
logging.basicConfig(filename='/home/santiagomartearena6/USGS-JPN_ETL_Task.log', level=logging.DEBUG) 
