...
topic_id = 'USGS-CHI_data'
subscription_id = 'start_delta_USGS-CHI-sub'
pubsub_client = None
topic_path = None
http_timeout = 10
...
#------------- MAIN -------------------
# File log config
logging.basicConfig(filename='/home/santiagomartearena6/USGS-CHI_API_Task.log', level=logging.DEBUG) 
