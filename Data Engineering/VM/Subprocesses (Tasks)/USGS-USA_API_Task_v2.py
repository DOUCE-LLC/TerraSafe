...
topic_id = 'USGS-USA_data'
subscription_id = 'start_delta_USGS-USA-sub'
pubsub_client = None
topic_path = None
http_timeout = 10
...
# ---------- Get Start and end Year for USGS-CHI API Query ------------    
def get_date_params():    
    client = bigquery.Client()                                                      # Create a Google Cloud Storage client 
    table_ref = 'terra-safe-391718.AIRFLOW.USGS_USA'                                # Specify your BigQuery table ID        
...
#------------- MAIN -------------------
# File log config
logging.basicConfig(filename='/home/santiagomartearena6/USGS-USA_API_Task.log', level=logging.DEBUG) 
